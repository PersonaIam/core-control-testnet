# Core v2 Management Tool - Persona TestNet

## Installation

```sh
git clone https://github.com/PersonaIam/core-control-testnet.git
cd core-control-testnet
...
- The snapshot is stored in the 'snapshots' folder in your home directory using the database name, e.g. persona_testnet. 
